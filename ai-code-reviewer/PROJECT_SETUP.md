...
- [Contents](#contents)
  - [Getting Started with AI Code Reviewer](#getting-started-with-ai-code-reviewer)
  - [Note ⚠️](#note-️)
  - [Bitbucket](#bitbucket)
    - [Enforce Branch Restrictions](#enforce-branch-restrictions)
    - [Add Environment Variables](#add-environment-variables)
    - [Regular projects setup in (bitbucket-pipelines.yml)](#regular-projects-setup-in-bitbucket-pipelinesyml)
    - [Native mobile projects setup in (bitbucket-pipelines.yml)](#native-mobile-projects-setup-in-bitbucket-pipelinesyml)
    - [Webhooks](#webhooks)
  - [Azure](#azure)
    - [Regular projects setup](#regular-projects-setup)
    - [Native mobile projects setup](#native-mobile-projects-setup)
  - [Gitlab](#gitlab)
    - [Regular projects setup](#regular-projects-setup-1)
    - [Native mobile projects setup](#native-mobile-projects-setup-1)
  - [Github](#github)
    - [Regular projects setup](#regular-projects-setup-2)
    - [Native mobile projects setup](#native-mobile-projects-setup-2)
  - [JIRA](#jira)
    - [Comments on tickets](#comments-on-tickets)
    - [JIRA Sprint validation](#jira-sprint-validation)
...
- **BITBUCKET_CODE_REVIEWER_ACCESS_TOKEN**
  - *Value:* BITBUCKET_CODE_REVIEWER_ACCESS_TOKEN_VALUE
- **CURRENT_REPO_ACCESS_GIT_URL**
  - *Value:* CURRENT_REPO_ACCESS_GIT_URL_VALUE
...
- **AI_CODE_REVIEW_PROJECT**
  - *Value:* AI_CODE_REVIEW_PROJECT_VALUE
...
- **Merged Pull Requests**
  ...
  - Put this URL in the URL box:
  - `https://api-opensenthex.eurisko.me/webhooks/bitbucket/postMerge?apiKey=YOUR_OPENSENTHEX_API_KEY`
...
- **CURRENT_REPO_ACCESS_GIT_URL**
  - *Value:* CURRENT_REPO_ACCESS_GIT_URL_VALUE
  - *Example:* `https://${PAT}@dev.azure.com/organization/project/_git/repo`
- **SONAR_PACKAGE_FILE** (Optional)
  - If your project is not a Node-based project—such as a native Android, iOS, or Python project—or essentially any project that does not have a package.json file in its root directory:
  - On your local machine, create any .json file
  - Write inside `{"name": "your-project-name", "version": "1.0.0"}`
...
- **CURRENT_REPO_ACCESS_GIT_URL**
  - *Value:* CURRENT_REPO_ACCESS_GIT_URL_VALUE
  - *Example:* `https://oauth2:{PAT}@gitlab.com/{GROUP}/{REPO}.git`
- **SONAR_PACKAGE_FILE** (Optional)
  - If your project is not a Node-based project—such as a native Android, iOS, or Python project—or essentially any project that does not have a package.json file in its root directory:
  - On your local machine, create any .json file
  - Write inside `{"name": "your-project-name", "version": "1.0.0"}`
...
- **CODE_REVIEWER_GITHUB_ACCESS_TOKEN**
  - *Value:* CODE_REVIEWER_GITHUB_ACCESS_TOKEN_VALUE
- **CURRENT_REPO_ACCESS_GIT_URL**
  - *Value:* CURRENT_REPO_ACCESS_GIT_URL_VALUE
- **AI_CODE_REVIEW_GIT_AUTH**
  - *Description:* Git authorization for the AI Code Reviewer engine. This will enable the AI Code Reviewer to operate within your project during reviews.
